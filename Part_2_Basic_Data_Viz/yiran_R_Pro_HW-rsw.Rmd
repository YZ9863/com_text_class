...
#wells note - a bit simpler method using top_n
mob |> 
  #filter nas
  filter(!is.na(Newspaper)) |> 
  count(Newspaper) |>
...
#wells comment: Nice catch: "The main flaw I found about the datasest is the redundancy of key words. For example, mob and mobs represent the same concept, but are coded as two different and separate topics."
